  ...
  <%@ page import="java.sql.*" %>
    ...
    <%@taglib prefix="c" uri="jakarta.tags.core" %>
      ...
      <style>
        ...
        /* Add appropriate styling for the pop-up */
        .popup {
          position: fixed;
          top: 150px;
        ...
        <% if(session.getAttribute("username")!=null ){ %>
              ...
              <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  <li class="nav-item active text-secondary">
                    <a class="nav-link " href="MoviesReport">Dashboard</a>
                  </li>
          ...
          <div class="container mt-3">
            ...
            <div class="row">
              <div class="col-md-4">
                <!-- Search Form -->
                <form action="SearchMovies" method="get" class="form-inline">
              ...
              <c:if test="${showReviewAddedPopup}">
                <div class="popup ">
              ...
              <div id="movieListContainer" class="container mt-5 my-3 py-3  rounded-lg shadow-lg">
                <h4 class="text-white">${filterMessage}</h4>
                <a href="MoviesReport">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="reviewModalLabel">${cm.name}</h5>
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <!-- Column 1: Movie Details -->
                            <div class="col-md-6">
                              <!-- Existing user reviews -->
                              <h4>Reviews</h4>
                              <ul class="list-unstyled">
                                <c:forEach items="${cm.reviews}" var="review">
                                  <li class="media mb-3">
                                    <img src="images/user1.png" class="mr-3" alt="User Icon"
                            ...
                            <!-- Column 2: Reviews and Write Review Form -->
                            <div class="col-md-6">
                              ...
                              <div class="mt-3">
                                ...
                                <form action="SubmitReview" method="post">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea name="reviewText" class="form-control" id="reviewText" rows="4"
                                      required></textarea>
                                  </div>
                                  ...
                                  <button value="Submit" type="submit" class="btn btn-primary">Submit Review</button>
                                </form>
                              </div>
              ...
              <% }%>
                ...
                <script>
                  ...
                  $(document).ready(function () {
                    ...
                    var reviewAdded = "${sessionScope.reviewAdded}";
